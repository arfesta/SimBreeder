...
source('/mnt/simulator/calc_TGV.R')
source('/mnt/extract_selections.new3.R')
...
for(pop.num in 2:10){
  ...
  this.gen <- all_seeds[[pop.num]]
  
  load.pop <- paste0("/mnt/data/base_population_op_testing/base_population_op_test_",pop.num,".RData")
load(load.pop)
...
set.seed(this.gen[1]); progeny1.phenos <- sim_phenos(TGV.object = progeny1.TGV,h2 = indiv.tree.h2)

progeny1.extractions <- extract_selections(map.info = base_pop_data$genetic.map,cross.design = cross.design,past.tgv = base_pop_data$parents.TGV,
...
progeny2.extractions <- extract_selections(map.info = base_pop_data$genetic.map,cross.design = cross.design,past.tgv = progeny1.TGV,
...
####Generations 3####
set.seed(this.gen[3]+1); cross.design <- create_cross_design(parent.info = progeny2.extractions,prog.percross = prog.per.cross,generation  = 3)
...
progeny3.extractions <- extract_selections(map.info = base_pop_data$genetic.map,cross.design = cross.design,past.tgv = progeny2.TGV,
...
####Generations 4####
set.seed(this.gen[4]+1); cross.design <- create_cross_design(parent.info = progeny3.extractions,prog.percross = prog.per.cross,generation  = 4)
...
progeny4.extractions <- extract_selections(map.info = base_pop_data$genetic.map,cross.design = cross.design,past.tgv = progeny3.TGV,
...
####Generations 5####
set.seed(this.gen[5]+1); cross.design <- create_cross_design(parent.info = progeny4.extractions,prog.percross = prog.per.cross,generation  = 5)
...
progeny5.extractions <- extract_selections(map.info = base_pop_data$genetic.map,cross.design = cross.design,past.tgv = progeny4.TGV,
...
####Generations 6####
set.seed(this.gen[6]+1); cross.design <- create_cross_design(parent.info = progeny5.extractions,prog.percross = prog.per.cross,generation  = 6)
...
progeny6.extractions <- extract_selections(map.info = base_pop_data$genetic.map,cross.design = cross.design,past.tgv = progeny5.TGV,
...
####Generations 7####
set.seed(this.gen[7]+1); cross.design <- create_cross_design(parent.info = progeny6.extractions,prog.percross = prog.per.cross,generation  = 7)
...
progeny7.extractions <- extract_selections(map.info = base_pop_data$genetic.map,cross.design = cross.design,past.tgv = progeny6.TGV,
...
####Generations 8####
set.seed(this.gen[8]+1); cross.design <- create_cross_design(parent.info = progeny7.extractions,prog.percross = prog.per.cross,generation  = 8)
...
progeny8.extractions <- extract_selections(map.info = base_pop_data$genetic.map,cross.design = cross.design,past.tgv = progeny7.TGV,
...
####Generations 9####
set.seed(this.gen[9]+1); cross.design <- create_cross_design(parent.info = progeny8.extractions,prog.percross = prog.per.cross,generation  = 9)
...
progeny9.extractions <- extract_selections(map.info = base_pop_data$genetic.map,cross.design = cross.design,past.tgv = progeny8.TGV,
...
####Generations 10####
set.seed(this.gen[10]+1); cross.design <- create_cross_design(parent.info = progeny9.extractions,prog.percross = prog.per.cross,generation  = 10)
...
progeny10.extractions <- extract_selections(map.info = base_pop_data$genetic.map,cross.design = cross.design,past.tgv = progeny9.TGV,
